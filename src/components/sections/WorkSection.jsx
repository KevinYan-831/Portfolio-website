      ...
      <div className="max-w-6xl mx-auto px-6">
        <ScrollStack>
          {projects.map((project, idx) => (
            <ScrollStackItem key={project.id} index={idx} total={projects.length}>
              <Link to={`/project/${project.id}`}>
                <div className="bg-white rounded-3xl p-8 md:p-12 border border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.01] mb-8">
